...
2. Drag and drop 'wizchip_mqtt_subscribe.uf2' onto the USB mass storage device 'RPI-RP2' or 'RP2350'.
...
7. If the MQTT Subscribe example works normally on the pico, you can see the network information of the pico, connecting to the broker and subscribing to the subscribe topic.
