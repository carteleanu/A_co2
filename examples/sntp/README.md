...
2. Setup network configuration such as IP in 'wizchip_sntp.c' which is the SNTP example in 'WIZnet-PICO-C/examples/sntp/' directory.
...
3. Setup SNTP configuration in 'wizchip_sntp.c' in 'WIZnet-PICO-C/examples/sntp/' directory.
...
2. When the build is completed, 'wizchip_sntp.uf2' is generated in 'WIZnet-PICO-C/build/examples/sntp/' directory.
...
5. If the SNTP example works normally on the pico, you can see the network information and time get from the SNTP server.
