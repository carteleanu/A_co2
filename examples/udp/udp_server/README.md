...
2. Setup network configuration such as IP in 'wizchip_udp_server.c' which is the UDP Server example in 'WIZnet-PICO-C/examples/udp/udp_server' directory.
...
3. Setup UDP Server configuration in 'wizchip_udp_server.c' in 'WIZnet-PICO-C/examples/udp/udp_server' directory.
...
2. When the build is completed, 'wizchip_udp_server.uf2' is generated in 'WIZnet-PICO-C/build/examples/udp/udp_server' directory.
...
2. Drag and drop 'udp_server/wizchip_udp_server.uf2' onto the USB mass storage device 'RPI-RP2' or 'RP2350'.
...
5. If the UDP Server example works normally on the pico, you can see the network information of the pico and the UDP Server server is open.
