...
2. Setup network configuration such as IP in 'wizchip_netbios.c' which is the Loopback example in 'WIZnet-PICO-C/examples/netbios/' directory.
...
2. When the build is completed, 'wizchip_netbios.uf2' is generated in 'WIZnet-PICO-C/build/examples/netbios/' directory.
...
2. Drag and drop 'wizchip_netbios.uf2' onto the USB mass storage device 'RPI-RP2' or 'RP2350'.
...
5. If the Netbios example works normally on the pico, you can see the network information of the pico and the udp is open.
...
7. If search command's name and name on the pico is correct, you can see the receive name on terminal.
